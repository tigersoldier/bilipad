...
export class GamepadButtonEvent {
    constructor(readonly gamepad: Gamepad, readonly button: GamepadButton, readonly buttonId: ButtonId, readonly eventType: EventType) {
    }
}
...
export class GamepadManager {
    ...
    emitButtonEvent(gamepad: Gamepad, button: GamepadButton, buttonId: ButtonId, eventType: EventType) {
    ...
    addEventListener(func: (event: GamepadButtonEvent) => void): { remove: () => void } {
